...
<head>
    ...
    <title>ЛинГА - Азбучен избор</title>
    <!-- Bootstrap CSS -->
     ...
     <main>
     	<div class="container">
     		<div class="row text-center ">
     			<div class="col mt-3">
     				<c:forEach var="letter" varStatus="letterNum" items="${letters}">
     					<c:if test="${letterNum.index % 4 == 0 }"> 
     					<br>
     					</c:if>
     					<a class="mt-2 btn btn-primary" href="/letterSearch?letter=${letter}">${letter}</a>
     				</c:forEach>
     			</div>
     		</div>
     	</div>
